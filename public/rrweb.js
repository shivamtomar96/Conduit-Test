        ...
        return function (arg) {
            if (arg && typeof arg === 'object' && 'rr_type' in arg) {
                if ('index' in arg) {
                    ...
                    return new (ctor.bind.apply(ctor, __spread([void 0], args.map(deserializeArg(imageMap, ctx)))))();
                }
            ...
            try {
                for (var args_2 = __values(args), args_2_1 = args_2.next(); !args_2_1.done; args_2_1 = args_2.next()) {
                    ...
                    if (!arg || typeof arg !== 'object') {
                        ...
                        images.push.apply(images, __spread(this.getImageArgs(arg.args)));
                    }
                    else if ('rr_type' in arg && arg.rr_type === 'HTMLImageElement') {
                        images.push(arg.src);
                    }
                    else if (arg instanceof Array) {
                        images.push.apply(images, __spread(this.getImageArgs(arg)));
                    }
                }
            }
